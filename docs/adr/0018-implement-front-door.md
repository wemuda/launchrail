...
## Status
Accepted — supersedes [ADR-0014](0014-start-feature-conductor.md); amends [ADR-0005](0005-ralph-two-frontends-one-policy.md) (gate placement, workflow-file distribution) and [ADR-0017](0017-implementation-loop-provider.md) (stage-10 handoff target). Amended by [ADR-0019](0019-vendor-skills-retire-plugin.md) (under vendored skills the front door is invoked `/launch-implement`, not `/launchrail:implement`) and [ADR-0020](0020-independent-skill-set.md) (the provider dimension is gone — the door drives Ralph, the sole implementation loop).
