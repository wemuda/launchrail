...
| [0027](0027-ralph-gate-ci-wait-repoll.md) | Ralph merge gate: re-poll a still-running CI in place instead of rebuilding | Accepted — amends 0022 |
