...
| [0004](0004-browser-testing-module.md) | Browser-testing module (Playwright, evidence bundles) | Accepted — amended by 0034 |
...
| [0034](0034-browser-smoke-one-off-driving.md) | Browser smoke is one-off driving of the running stack; the e2e lane stays thin | Accepted — amends 0004 |
