...
| [0004](0004-browser-testing-module.md) | Browser-testing module (Playwright, evidence bundles) | Accepted — amended by 0034, 0036 |
...
| [0028](0028-hosted-session-designated-branch-target.md) | Hosted-session Ralph runs target the session's designated branch | Accepted — amends 0026; amended by 0032, 0035 |
...
| [0032](0032-ralph-lean-local-gate-loop.md) | Ralph lean loop: local landing under a fast gate, continuous persistence, checkpointed full gate | Accepted — amends 0005, 0010, 0022, 0028; supersedes 0027, 0030; extended by 0033; amended by 0035 |
...
| [0034](0034-browser-smoke-one-off-driving.md) | Browser smoke is one-off driving of the running stack; the e2e lane stays thin | Accepted — amends 0004; amended by 0036 |
| [0035](0035-ralph-preflight-verifies-base-on-remote.md) | Ralph preflight verifies the integration base on the live remote | Accepted — amends 0032, 0028 |
| [0036](0036-cli-owned-stack-start.md) | The CLI owns the smokeable stack's start contract (`launchrail dev`); composed stacks are declared | Accepted — amends 0034, 0004 |
