...
| `docs/adr/0000-template.md` | seeded | ADR template (records are named `YYYY-MM-DD-slug.md`). |
| `docs/adr/README.md` | seeded | ADR registry — the index table is regenerated by `launchrail adr index`; the rest is yours ([ADR-0031](../docs/adr/0031-adr-registry-and-reading-contract.md), [adr-date-slug-identifiers](../docs/adr/2026-09-11-adr-date-slug-identifiers.md)). |
